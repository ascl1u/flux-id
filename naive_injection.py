    ...
    def __call__(self, attn, hidden_states, encoder_hidden_states=None, attention_mask=None, image_rotary_emb=None):
        ...
        if REF_CACHE["mode"] == "WRITE":
            ...
            if ref_k is not None:
                ...
                if batch_size == 1: 
                    print(f"  [READ] Injection Active. Total Tokens: {key.shape[2]}")
        ...
        # split joint sequence back into image (1024) and text (512)
...
print(">>> Installing Processor...")
pipe.transformer.transformer_blocks[0].attn.processor = FluxInjectionProcessor()
...
if REF_CACHE["keys"] is not None:
    ...
    result.save("naive_injection.png")
    print("\n>>> SUCCESS. Check 'naive_injection.png'")